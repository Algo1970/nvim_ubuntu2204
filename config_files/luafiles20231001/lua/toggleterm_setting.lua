...
vim.api.nvim_set_keymap("n", "<leader>te", "<cmd>lua _bash_toggle()<CR>", {noremap = true, silent = true})
...
vim.api.nvim_set_keymap("n", "<localleader>p", "vip:ToggleTermSendVisualSelection<CR>", {noremap = true, silent = true})
